# System Design
System design is the process of defining the elements of a system, as well as their interactions and relationships, in order to satisfy a set of specified requirement.
...
payment service, and database interact with each other.
Syllabus
